...
App.UnitsRoute = Ember.Route.extend({
	model: function (params) {
		...
		jQuery.getJSON(url, function(json) {
			Ember.set(App.KWCHART[0], 'value', formatNumber(json.quantity.value.toFixed(2)));
		...
		jQuery.getJSON(url, function(json) {
			Ember.set(App.KWCHART[1], 'value', formatNumber(json.quantity.value.toFixed(2)));
		...
		jQuery.getJSON(url, function(json) {
			Ember.set(App.KWCHART[2], 'value', formatNumber(json.quantity.value.toFixed(2)));
